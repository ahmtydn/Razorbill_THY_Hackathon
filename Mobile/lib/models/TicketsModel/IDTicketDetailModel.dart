...
//
//     final getIdTicketDetailModel = getIdTicketDetailModelFromJson(jsonString);

import 'dart:convert';

GetIdTicketDetailModel getIdTicketDetailModelFromJson(String str) => GetIdTicketDetailModel.fromJson(json.decode(str));

String getIdTicketDetailModelToJson(GetIdTicketDetailModel data) => json.encode(data.toJson());

class GetIdTicketDetailModel {
  GetIdTicketDetailModel({
    required this.id,
    ...
    required    this.getIdTicketDetailModelClass,
    required    this.meal,
  ...
  String pnr;
  String seatNumber;
  int getIdTicketDetailModelClass;
  String meal;
  int baggage;
  int cabinBaggage;
  String passengerId;
  ...
  factory GetIdTicketDetailModel.fromJson(Map<String, dynamic> json) => GetIdTicketDetailModel(
    id: json["id"],
    ...
    getIdTicketDetailModelClass: json["class"],
    meal: json["meal"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "class": getIdTicketDetailModelClass,
    "meal": meal,
    "baggage": baggage,
